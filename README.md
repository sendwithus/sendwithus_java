...
This client is a working development repository, please use the `1.0.7` jar or maven repository. _Do not_ build
the client yourself.
...
### via wget:
    ...
    $ wget https://github.com/sendwithus/sendwithus-mvn-repo/raw/master/releases/com/sendwithus/java-client/1.0.7/java-client-1.0.7.jar
